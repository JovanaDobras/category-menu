...
import './App.css';
import  ContentMenu from './components/common/ContentMenu/ContentMenu.jsx';
...
function App() {
  ...
  const menu = [
    ...
    const [listMenu, setList] = useState(menu);

  return (
    <div className="App">
      
      <ContentMenu listMenu={listMenu} setList={setList} menu={menu}/>
